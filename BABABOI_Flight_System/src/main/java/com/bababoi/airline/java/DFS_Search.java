...
public class DFS_Search extends JFrame {
    ...
    public DFS_Search(Menu parentMenu) {
        this.parentMenu = parentMenu;

        setTitle("BABABOI Airline Flight System - DFS Search Route");
    ...
    private JPanel createHeader() {
        ...
        JLabel subtitle = new JLabel("Depth-First Search (DFS) Route");
    ...
    private JScrollPane createMainContent() {
        ...
        JLabel heading = new JLabel("Find Route using DFS");
        heading.setFont(new Font("SansSerif", Font.BOLD, 22));
        heading.setForeground(TEXT);
        heading.setAlignmentX(Component.LEFT_ALIGNMENT);

        JLabel description = new JLabel("Select departure and destination airports to find a route using Depth-First Search.");
        ...
        // Result area
        JLabel resultHeading = new JLabel("DFS Route Result");
    ...
    private void findRoute() {
        ...
        List<Integer> path = dfs(fromId, toId);

        if (path.isEmpty()) {
            resultArea.setText("");
            resultArea.append("========================================\n");
            resultArea.append("  DFS ROUTE RESULT\n");
            resultArea.append("========================================\n\n");
            ...
            resultArea.append("!\n\n");
            resultArea.append("The destination airport is not reachable using DFS.\n");
            resultArea.append("========================================\n");
    ...
    private List<Integer> dfs(int start, int goal) {
    ...
    private void displayRoute(List<Integer> path, int fromId, int toId) {
        ...
        resultArea.append("\n========================================\n");
        resultArea.append("  * Route found using Depth-First Search (DFS)\n");
        resultArea.append("========================================\n");
    }
    ...
    private void updateStatus() {
        ...
        if (fromId == -1 || toId == -1) {
            ...
            showStatus("Ready to find route using DFS.", SUCCESS);
        }
    }
    ...
    private JPanel createFooter() {
        ...
        JLabel right = new JLabel("Depth-First Search (DFS)");
